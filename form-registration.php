...
<body onLoad="tiktak();">
<main class='container-fluid col-lg-12 wrapper px-0 px-md-3' style = 'display: flex; width:100vw; height: 100vh; justify-content: center; align-items: center; text-align: center'>
<?php
// $to  = 'info@gelster.ru';
$to  = 'web@gelster.ru';
...
$message = "Фамилия: ".$lastname."<br> Имя: ".$name."<br> E-mail: ".$email."<br> Телефон: ".$tel;
...
if ($send == 'true') {
    echo "<p class='window_zayavka'><span class= 'header'>Спасибо за регистрацию!</span><br><span class = 'header-two'>Мы отправим счет на оплату обучения на вашу почту.</span><br><br>Страница будет закрыта через <span id='timer'></span> секунд.<br><a class='window_zayavka-btn' href='#' onclick='closeWindow()'><span>Закрыть страницу</span></a></p>";
} else {
