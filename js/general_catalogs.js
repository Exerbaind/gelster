const showPropertyText = document.querySelectorAll('.item__text');
...
for (let showPropertyTextIndex = 0; showPropertyTextIndex < showPropertyText.length; showPropertyTextIndex++) {
    showPropertyText[showPropertyTextIndex].addEventListener('click', function () {
